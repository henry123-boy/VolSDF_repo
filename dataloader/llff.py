...
class Dataset(base.Dataset):
    ...
    def __init__(self,opt,split="train",subset=None):
        ...
        # get the poses [N,3,5], meanwhile the raw_H, raw_W are read here, and the bounds are also read here.
    ...
    def parse_cameras_and_bounds(self,opt):
        ...
        '''
        : contents in {}/pose_bounds.npy :
        content.shape  =[N,17]    N is the number of images, and 17 is the number of parameters for intrinsics+extrinsics+depth_bounds

        content[i,-2:] represents the min_depth and max_depth for ith image
        content[i,:-2].reshape(1,3,5) represent [R|T|k]  k=(H,W,Focal).transpose
        '''
        ...
        poses_raw[...,0],poses_raw[...,1] = poses_raw[...,1],-poses_raw[...,0]   # not sure the meaning of this operation
    ...
    def center_camera_poses(self,opt,poses):
        ...
        v0 = v1.cross(v2)         # v1 cross product v2, which ensure v0 is vertical to v1 and v2, but i wonder that it can not be ensured that v1 is vertical to v2
